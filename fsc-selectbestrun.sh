...
m=-1000000000000000
#p=$1  # removed this line-SMH
c=0
best="xxxx"
diff=0
diffBest=0

for i in Run_*;   # modification by Sean Harrington--run* to Run_* because I set this up differently
do
 a=$(ls Run_1 | grep ${p}".tpl" | sed s'/.tpl//') # Modified this-SMH to "ls Run_1 |"" from "ls |""
